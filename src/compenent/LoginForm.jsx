...
<div className="sm:mx-auto sm:w-full sm:max-w-sm">
    <img
        ...
        alt="Your Company"
    />
    <h2 className="mt-10 text-2xl font-bold leading-9 tracking-tight text-center text-gray-50">
...
<div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
    ...
    <p className="mt-10 text-sm text-center text-gray-500">
        Not a member?{' '}
        <a href="#" className="font-semibold leading-6 text-orange-500 hover:indigo-500">
